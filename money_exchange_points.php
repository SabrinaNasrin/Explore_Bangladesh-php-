...
<head>
  ...
  <title>Money Exchange Points</title>
  <meta charset="UTF-8"/>
    ...
    <div id="content" role="main">
            ...
            <article class="post-139 page type-page status-publish hentry">
                ...
                <div class="page-content">
                    <p>&nbsp;</p>
<h3><span style="color: #000000;"><b>Latest Exchange Rate</b></span></h3>
<p><span style="color: #000000;"><a style="color: #000000;" href="http://www.bangladesh-bank.org/econdata/exchangerate.php" target="_blank">Please visit official exchange rates of Taka by Bangladesh Bank</a></span></p>
<p>&nbsp;</p>
<h3><span style="color: #000000;"><b>Money Exchange Points</b></span></h3>
<p>&nbsp;</p>
<?php
  ...
  $query = "SELECT * FROM `money_exchange_points` WHERE 1";
  $result = mysqli_query($con,$query);


  while($row=mysqli_fetch_array($result)){ 
 
  echo("<b>$row[name5]:</b> <br><br> $row[address3]<br><br>");   
