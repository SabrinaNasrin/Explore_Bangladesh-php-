...
<body>
  ...
  <p style="text-align: justify;"><a href="image/welcome.jpg">
    <img class="size-full wp-image-11206 alignleft" src="image/welcome.jpg" alt="800px-Deers_at_Dhaka_Zoo" width="100%" height="180">
  </a>
</p>
  ...
  <div class="main-content col-md-9">
    ...
    {
          $con = mysqli_connect("localhost", "root" ,"", "explore_bangladesh" ) or die("Connection Failed");
          $name15=$_POST['search'];
          $query = "SELECT * FROM all_link WHERE all_link.name15='$name15' ";
          ...
          {
            echo "<script>
              alert('Sorry!!!Wrong Query!!!try again please!!');
            </script>";
         }
          ...
          else
          {
            ...
            echo "<td><a href=\"$row[link]\" >$row[name15]</a></td>";
          }
  }
?>
</div>
