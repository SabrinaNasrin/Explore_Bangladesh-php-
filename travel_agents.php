    ...
    <div id="content" role="main">
            ...
            <article class="post-1815 page type-page status-publish hentry">
                ...
                <div class="page-content">
                    <p style="text-align: center;"><span style="color: black; font-size:30px;"><strong> Travel&nbsp;Agents List</strong></span></p>
...
<?php
  ...
  $query = "SELECT * FROM `travel agent` WHERE 1";
  $result = mysqli_query($con,$query);


  while($row=mysqli_fetch_array($result)){ 
 
  echo("<tr><td>$row[name8]</td>
    <td> $row[address4] </td>
<td>$row[phone] </td>
<td>$row[website]</td>
 <td>$row[email]</td></tr>");   
