...
function carousel() {
  ...
  <p>&nbsp;</p>
  <h3>Bangladesh National Zoo</h3>
  <p style="text-align: justify;"><a href="image/deer.jpeg" style="float:left;padding-right:15px;"><img class="size-full wp-image-11206 alignleft" src="image/deer.jpeg" alt="800px-Deers_at_Dhaka_Zoo" width="400" height="267"></a><span style="color: #000000;font-size:18px;">Located in the Mirpur section of the capital city of Bangladesh, the Bangladesh National Zoo is home to more than 2,000 animals from 165 species and is a popular place to spend the day, both for local and international visitors. Established in 1974, the Bangladesh National Zoo has been developed and improved over the years, and is widely considered to be one of the best zoos in Bangladesh, receiving hundreds of thousands of visitors each year.Visitors to the National Zoo will appreciate the way animal enclosures are designed to make each occupant feel at home by keeping the animal’s natural environment as closely as possible. Of course,the animals are safe behind bars, but the overall appearance of the zoo, with its tree-lined pathways and two large tranquil lakes that host migratory water-fowl each winter, gives one the impression of being out in the country side rather than within the boundaries of one of the busiest cities in Bangladesh.</span></p>
