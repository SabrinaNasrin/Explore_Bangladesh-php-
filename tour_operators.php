...
function carousel() {
  ...
  <div id="content" role="main">
            ...
            <article class="post-1707 page type-page status-publish hentry">
                
                <div class="page-content">
                    <p style="text-align: center;"><span style="color: black;font-size:30px;line-height:50px;">
                      <strong> Tour Operator List</strong></span></p>

<table class="Design7" width="784" cellspacing="0">
  <thead>
<tr>
<th width="86"><strong>Name</strong></th>
<th width="168"><strong>Address</strong></th>
<th class="Odd" width="144"><strong>Phone</strong></th>
<th class="Odd" width="92"><strong>Website</strong></th>
<th width="294"><strong>E mail</strong></th>
</tr>
</thead>
...
<?php
  ...
  $query = "SELECT * FROM `tour operator` WHERE 1";
  $result = mysqli_query($con,$query);


  while($row=mysqli_fetch_array($result)){ 
 
  echo("$row[name7] $row[address4] $row[phone] $row[website] $row[email]");   
